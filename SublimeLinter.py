...
MARK_THEMES_PATH = os.path.join(('..' if int(sublime.version()) < 3014 else 'Packages'), 'SublimeLinter', 'gutter_mark_themes')
            ...
            if outlines[lint_type]:
                ...
                if gutter_mark_enabled:
                    if gutter_mark_theme == 'original':
                        ...
                        gutter_mark_image = os.path.join(MARK_THEMES_PATH, gutter_mark_theme + '-' + lint_type + '.png')
                    else:
